...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        /* Modern Navigation Tabs (Same as Staff Dashboard) */
        .nav-tabs {
            display: flex;
            gap: 12px;
            margin-bottom: 25px;
...
<body>
    ...
    <div class="container">
        ...
        <!-- Navigation Tabs Bar (Matching Staff Dashboard) -->
        <div class="nav-tabs">
            <button class="tab-btn active" onclick="switchTab('appointments-tab')">
                <i class="fa-solid fa-list-check"></i> Appointment Workflow
            </button>
            <button class="tab-btn" onclick="switchTab('invoices-tab')">
                <i class="fa-solid fa-receipt"></i> Issued Invoices History
            </button>
            <button class="tab-btn" onclick="switchTab('doc-guide-tab')">
        ...
        <div id="appointments-tab" class="tab-content active">
            <div class="card-header">
                <div class="card-title">
                    <i class="fa-solid fa-list-check"></i> Patient Appointments & Treatment Workflow
                </div>
        ...
        <div id="invoices-tab" class="tab-content">
            <div class="card-header">
                <div class="card-title">
                    <i class="fa-solid fa-receipt"></i> Issued Invoices & Payment Receipts History
                </div>
                <div class="search-box">
                    <i class="fa-solid fa-magnifying-glass"></i>
        ...
        <div id="doc-guide-tab" class="tab-content">
            ...
            <div class="help-box">
                <h4><i class="fa-solid fa-1"></i> Updating Treatment Status</h4>
                <p>Locate the patient in <strong>Appointment Workflow</strong> tab, choose status (Pending / Done / Completed) from dropdown, and click 'Save'.</p>
            </div>
            <div class="help-box">
            ...
            <div class="help-box">
                <h4><i class="fa-solid fa-3"></i> Issuing Final Receipt</h4>
                <p>Review the calculated bill summary card and click 'Issue & Save Invoice Receipt' to record the bill into system database.</p>
            </div>
        </div>
    ...
    <script>
        ...
        function calculateBillViaAPI(apptNum) {
            const apiUrl = '<%= request.getContextPath() %>/api/billing/' + apptNum;
